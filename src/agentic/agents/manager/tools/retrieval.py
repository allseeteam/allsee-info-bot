...
retrieval_tool = create_retriever_tool(
    ...
    description=(
        ...
        - Наша миссия
        - Профиль компании
        - Ценности (10 основных ценностей компании)
        - Легенда и история (включая символику и философию)
        - Выгоды от ИИ, которые мы даем
        - Наши преимущества
        - Наши решения для бизнеса (Разработка ИИ-ботов, Внедрение RAG, Внедрение LLM, Создание приложения с ИИ, Внедрение генеративного ИИ, Автоматизация с ИИ)
        - Готовые продукты для быстрого запуска (ИИ-дайджест новостей, ИИ-менеджер, ИИ-аналитик, ИИ-описания товаров, ИИ-секретарь)
        - Формат работы команды AllSee (управление проектом, форматы Time & Material и Fix Price)
        - Бизнес-результаты от внедрения ИИ (количественные и качественные результаты, сокращение затрат)
        """
    ),
)